...
export function EntryCalculator({
  ...
  return (
    <div className="my-9 border border-rule bg-[#FFFEFB] px-7 py-6.5">
      <div className="mb-4 font-utility text-[11px] uppercase tracking-[0.1em] text-ochre">
        {title}
      </div>

      <div className="mb-4.5 flex flex-wrap gap-4.5">
        {fields.map((f) => (
