...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://knowthiswell.com'; // Use env var for staging/preview support

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: { default: 'KnowThisWell', template: '%s — KnowThisWell' },
  description:
      ...
      <body className="bg-paper font-body text-ink antialiased">
        ...
        <footer className="mt-20 border-t border-rule px-5 py-10 font-utility text-xs text-ink-soft md:px-10">
          <div className="mx-auto flex max-w-[1180px] flex-wrap justify-between gap-6">
            <p>© {new Date().getFullYear()} KnowThisWell. Content may not be reproduced without permission.</p>
