...
export default function Post() {
  return (
    <>
      ...
      <p>
      Bangladesh has a total population of roughly 170 million people — well under half of Canada&apos;s neighbor, the United States — living in a land area of about 148,000 km², producing a population density around 1,300 people per km², among the highest of any large country in the world. Canada, by contrast, has a smaller total population (roughly 39-40 million) but a vastly larger land area of nearly 9.98 million km², putting its density at around 4 people per km² — one of the lowest of any populous country. Both countries have populations in the tens of millions, but their density figures differ by more than 300-fold, driven entirely by the difference in land area rather than population size.
      </p>
