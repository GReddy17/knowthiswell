...
export const metadata: PostFrontmatter = {
  ...
  tags: ["electricity", "magnetism", "circuits", "ohms law", "physics"],
  date: "2026-08-16",
  updated: "2026-08-16",
  lastReviewed: "2026-08-16",
  excerpt: "How electric current, voltage, and resistance relate through Ohm's law, and why electricity and magnetism are really one connected force.",
