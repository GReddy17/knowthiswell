  ...
  return (
    <>
      ...
      <ModeToggle
        ...
        plain={<div className="prose-p">The <TermLink href="/general-science-facts/water-cycle-and-oceans">water cycle</TermLink> is the ongoing loop water travels through: the sun heats the ocean surface, turning some of that water into invisible vapor that rises into the sky (<TermLink href="/general-science-facts/water-cycle-and-oceans">evaporation</TermLink>) — the same phase change covered at household scale in <TermLink href="/general-science-facts/states-of-matter-changes-in-daily-life">States of Matter Changes in Daily Life</TermLink>. High in the cooler atmosphere, that vapor turns back into tiny water droplets, forming clouds (<TermLink href="/general-science-facts/water-cycle-and-oceans">condensation</TermLink>). When those droplets combine and get heavy enough, they fall back down as rain or snow (<TermLink href="/general-science-facts/water-cycle-and-oceans">precipitation</TermLink>), which then flows into rivers, soaks into the ground, or runs straight back to the ocean — where the whole cycle starts again.</div>}
