...
export const metadata: PostFrontmatter = {
  ...
  subtopic: "matter-and-states-of-matter",
  tags: [
    "states of matter",
    "solid liquid gas",
    "physical science",
