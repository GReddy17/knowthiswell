...
export default function Post() {
  return (
    <>
      ...
      <div className="prose-p">
      A GPS app starts a 240-mile trip estimating 3 hours 42 minutes, based on 240 ÷ 65 mph ≈ 3.69 hours at the road&apos;s typical speed. After driving 20 minutes at that 65 mph pace (covering about 21.7 miles), a construction zone drops the car&apos;s speed to 40 mph, with about 218.3 miles still remaining. If the app projects that current 40 mph speed forward across the entire remaining distance, the new estimate becomes 218.3 ÷ 40 ≈ 5.46 hours — jumping the total trip estimate from 3 hours 42 minutes to roughly 5 hours 48 minutes (the 20 minutes already driven plus the new 5.46-hour projection), well beyond the 20 minutes that have actually elapsed. This isn&apos;t a measurement error: distance ÷ speed is being recomputed correctly at each instant, but it&apos;s projecting the temporary slow speed forward as if it will last the whole remaining trip. Once traffic clears and speed returns to 65 mph, the estimate drops back down just as sharply — which is exactly why live ETAs on a phone can swing by tens of minutes in either direction without anything being &quot;wrong&quot; with the math.
      </div>
